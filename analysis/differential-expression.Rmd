...
## Setup
[link]https://portal.aci.ics.psu.edu/rnode/comp-lc-0094.acib.production.int.aci.ics.psu.edu/8605/?view=rmarkdown
Load packages.
...
## Process samples
```{r}
barplot(log2cpm["ERCC-00130",])
barplot(log2cpm["ERCC-00165",])
...
```{r}
barplot(log2cpm["YGR234W", ], las = 2, cex.names = 0.75)
```
